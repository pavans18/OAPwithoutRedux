...
function Exam() {
    ...
    //         let value = await axios.get(`${baseUrl}/apiquestion/showQuestions`);
    ...
    const handleExamDeleteButton = (async (e) => {
        ...
        //         await axios.delete(`${baseUrl}/apiquestion/deleteQuestionInExam/${questions[i].id}`);
        //     }
        // }
    ...
    //         }
    //     }
    //     await axios.delete(`${baseUrl}/apiexam/deleteExam/${id}`);
    //     setStatusDeleteExam(true);
    // }
